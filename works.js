// 这是你的作品数据文件，以后改作品就改这里。
window.PORTFOLIO = {
  profile: {
    name: "甄宏林",
    tagline: "VIDEO PORTFOLIO",
    subtitle: "编导 · 剪辑 · 视频创作者"
  },

  categories: [
    { id: "documentary", name: "《三农群英汇》" },
    { id: "talent-talk", name: "达人口播类" },
    { id: "travel-vlog", name: "旅行 Vlog" },
    { id: "wedding-mv", name: "婚礼 MV" },
    { id: "art-exam", name: "艺考机构视频" }
  ],

  groups: [
    { id: "long-form", name: "纪实长视频", background: "backgrounds/documentary.jpg", categories: ["documentary"] },
    { id: "short-form", name: "短视频", background: "backgrounds/talent-talk.jpg", categories: ["talent-talk", "travel-vlog", "wedding-mv", "art-exam"] }
  ],
